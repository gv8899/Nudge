    ...
    >
      <div className="text-center space-y-8">
        ...
        >
          <button
            type="submit"
            className="flex w-full items-center justify-center gap-3 rounded-lg bg-white px-6 py-3 text-sm font-medium text-gray-800 shadow hover:bg-gray-50 transition-colors"
          >
        ...
        {process.env.AUTH_APPLE_ID && process.env.AUTH_APPLE_SECRET && (
          ...
          >
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-3 rounded-lg bg-black px-6 py-3 text-sm font-medium text-white shadow"
            >
