...
export function BlockDragHandle({
  ...
  return (
    <button
      ...
      onDragEnd={onDragEnd}
      className="hidden md:flex absolute left-0 items-center justify-center w-6 h-6 rounded text-text-faint hover:text-foreground hover:bg-muted cursor-grab active:cursor-grabbing transition-colors z-10"
      style={{
